...
connection.query("CREATE TABLE IF NOT EXISTS users (" +
  ...
  "PRIMARY KEY (user_id));", function(err, result) {
	if (err) {
    console.error("Create 'users' table failed.");
    throw err;
  }
});
...
connection.query("CREATE TABLE IF NOT EXISTS organizations (" +
  ...
  "PRIMARY KEY (org_id));", function(err, result) {
  if (err) {
    console.error("Create 'organizations' table failed.");
    throw err;
  }
});
...
connection.query("CREATE TABLE IF NOT EXISTS posts (" +
  ...
  if (err) {
    console.error("Create 'posts' table failed.");
    throw err;
  }
});

module.exports = connection;
module.exports.post_type = post_type;
