...
res.messages = function(msg, type) {
	...
	sess.messages = sess.messages || []; // make sure sess.messages defined
...
module.exports = function(req, res, next) {
	res.locals.messages = req.session.messages || []; //copy to local.message from session.messages is define, empty otherwise
